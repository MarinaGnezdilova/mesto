export class Card {
  constructor(data, templateSelector, openImagePopup, openPopupDelete, handleSetLike, handleDeleteLike, myid) {
  ...
  _setEventListeners() {
    ...
    this._handleDeleteLike(this._idCard, this._card, this._likeButton);
} else {
    this._handleSetLike(this._idCard, this._card, this._likeButton);
  }})
    this._iconDelete.addEventListener("click", () => {
      this._openPopupDelete(this._idCard, this._card);
    });
